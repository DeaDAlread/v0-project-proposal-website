...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "game.timeUpAnswer": "Time's Up! Answer was",
    ...
    "room.copied": "Copied!",
    "room.qrCode": "QR Code",
    "room.qrCodeTitle": "Join via QR Code",
    "room.qrCodeDescription": "Scan this code with your phone to join the lobby instantly",
    "room.qrCodeHint": "Scan with your phone camera to join",
    "room.checkingSession": "Checking for active session...",
    "room.deck": "Deck",
    ...
    "howToPlay.customDecks.text":
      'Create your own word decks from "My Decks" menu! Add themed words for personalized gameplay. Each deck needs at least 5 words to be playable.',
    "howToPlay.hostControls.title": "👥 Host Controls",
    "howToPlay.hostControls.text":
      "As the host, you can configure game settings, select decks, adjust round counts, and manually skip rounds if needed. All players can trigger round advances by guessing correctly.",
    ...
    "history.tableNotFoundMessage":
      'The game history feature is not set up yet. Please run the SQL migration script "012_add_game_history.sql" to enable game history tracking.',
    ...
    "profile.imageUploadError": "Please upload a valid image file (JPG, PNG, GIF, or WebP)",
    "profile.imageFormatError": "Invalid image format. Only JPG, PNG, GIF, and WebP are supported.",
    "profile.imageTooLargeError": "Image file is too large. Maximum size is 5MB.",
    "profile.emailChangeNote": "Changing your email will require verification via email",
    "profile.profilePictureNotAvailable":
      "Profile pictures are not available yet. Please run migration script 011_add_profile_picture.sql to enable this feature.",

    // Results page translations
    "results.gameOver": "Game Over!",
    "results.winner": "Winner",
    "results.finalScoreboard": "Final Scoreboard",
    "results.you": "You",
    "results.point": "point",
  ...
  th: {
    ...
    "auth.signup.termsDisclaimer":
      " ฉันเข้าใจว่าบริการนี้ให้บริการตามสภาพที่เป็นอยู่ และผู้พัฒนาไม่รับผิดชอบต่อข้อมูลรั่วไหลหรือข้อมูลที่แบ่งปันผ่านแพลตฟอร์ม",
    ...
    "game.guest": "แขก",
    "game.endGame": "จบเกม",
    "game.timeUpAnswer": "หมดเวลา! คำตอบคือ",
    ...
    "room.qrCode": "QR Code",
    "room.qrCodeTitle": "เข้าร่วมผ่าน QR Code",
    "room.qrCodeDescription": "สแกนโค้ดนี้ด้วยโทรศัพท์เพื่อเข้าร่วมห้องทันที",
    "room.qrCodeHint": "สแกนด้วยกล้องโทรศัพท์เพื่อเข้าร่วม",
    "room.checkingSession": "กำลังตรวจสอบเซสชันที่ใช้งานอยู่...",
    "room.deck": "เด็ค",
    ...
    "howToPlay.customDecks.text":
      'สร้างเด็คคำศัพท์ของคุณเองจากเมนู "เด็คของฉัน"! เพิ่มคำตามธีมสำหรับเกมส์ที่เป็นส่วนตัว แต่ละเด็คต้องมีอย่างน้อย 5 คำเพื่อเล่นได้',
    "howToPlay.hostControls.title": "👥 การควบคุมของเจ้าของห้อง",
    "howToPlay.hostControls.text":
      "ในฐานะเจ้าของห้อง คุณสามารถตั้งค่าเกม เลือกเด็ค ปรับจำนวนรอบ และข้ามรอบด้วยตนเองได้ ผู้เล่นทุกคนสามารถไปรอบถัดไปได้โดยการเดาถูก",
    ...
    "history.tableNotFoundMessage":
      'ฟีเจอร์ประวัติเกมยังไม่ได้ตั้งค่า กรุณารันสคริปต์ SQL "012_add_game_history.sql" เพื่อเปิดใช้งานการบันทึกประวัติเกม',
    ...
    "profile.imageUploadError": "กรุณาอัพโหลดไฟล์รูปภาพที่ถูกต้อง (JPG, PNG, GIF หรือ WebP)",
    "profile.imageFormatError": "รูปแบบไฟล์ไม่ถูกต้อง รองรับเฉพาะ JPG, PNG, GIF และ WebP เท่านั้น",
    "profile.imageTooLargeError": "ไฟล์รูปภาพใหญ่เกินไป ขนาดสูงสุดคือ 5MB",
    "profile.emailChangeNote": "การเปลี่ยนอีเมลจะต้องมีการยืนยันผ่านอีเมล",
    "profile.profilePictureNotAvailable":
      "รูปโปรไฟล์ยังไม่สามารถใช้งานได้ กรุณารันสคริปต์ 011_add_profile_picture.sql เพื่อเปิดใช้งานฟีเจอร์นี้",

    // Results page translations in Thai
    "results.gameOver": "เกมจบแล้ว!",
    "results.winner": "ผู้ชนะ",
    "results.finalScoreboard": "คะแนนสุดท้าย",
    "results.you": "คุณ",
    "results.point": "คะแนน",
    "results.points": "คะแนน",
    "results.backToHome": "กลับหน้าหลัก",
    "results.viewLeaderboard": "ดูกระดานผู้นำ",
    "results.rematch": "เล่นใหม่",
  },
}
