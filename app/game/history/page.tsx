  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(to_bottom_right,hsl(var(--gradient-from)),hsl(var(--gradient-via)),hsl(var(--gradient-to)))] p-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-primary">{t("history.title")}</CardTitle>
          </CardHeader>
        </Card>

        {games.length === 0 ? (
          <Card>
            <CardContent className="p-6 text-center text-muted-foreground">{t("history.noHistory")}</CardContent>
          </Card>
        ) : (
              ...
              <Card key={game.id}>
                <CardContent className="p-6">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <h3 className="font-bold text-lg">
                          {game.winner_name} {t("history.won")}
                        </h3>
                    ...
                    {game.players.map((player, index) => (
                      <div key={index} className="flex items-center justify-between p-2 bg-muted rounded">
                        ...
                        <span className="font-medium">
                          {player.final_score} {t("history.pts")}
                        </span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <span>
                      {game.total_rounds} {t("history.rounds")}
                    </span>
                  </div>
                </CardContent>
              </Card>
